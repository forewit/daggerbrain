		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>Make an attack with your primary weapon against a target within Melee range. On a success, you deal damage and knock them back to Close range.</p>
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When an ally within Very Close range would take damage, you can <b>mark a Stress</b> to stand in the way and make yourself the target of the attack instead.</p>
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>You use the full force of your body in a fight. On a successful attack using a weapon with a Melee range, gain a bonus to your damage roll equal to your <b>Strength</b>.</p>`,
				character_modifiers: []
			}
		]
	},
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When you make a <b>Presence Roll</b>, you can <b>spend a Hope</b> to add your <b>Strength</b> to the roll.</p>
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>Once per rest, when you <b>critically succeed</b> on an attack, all allies within Very Close range can <b>clear a Stress</b> or <b>gain a Hope</b>.</p>`,
				character_modifiers: []
			}
		]
	},
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>Once per long rest, when you console or inspire an ally who failed an action roll, you can both <b>clear 2 Stress</b>.</p>`,
				character_modifiers: []
			}
		]
	},
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>Describe how you taunt a target within Close range, then make a <b>Presence Roll</b> against them. On a success:</p>
                     <ul class="list-disc list-inside ml-2">
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When an ally within Close range fails a roll, you can <b>spend 2 Hope</b> to allow them to reroll either their Hope or Fear Die.</p>`,
				character_modifiers: []
			}
		]
	},
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>While you're wearing armor, gain a +1 bonus to your Armor Score.</p>
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>Once per rest, when you <b>critically succeed</b> on an attack, you and all allies who can see or hear you can <b>clear a Hit Point</b> or <b>1d4 Stress</b>.</p>`,
				character_modifiers: []
			}
		]
	},
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When you <b>fail an action roll</b>, your next action roll has <b>advantage</b>.</p>`,
				character_modifiers: []
			}
		]
	},
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>Gain a bonus to your Severe threshold equal to your Proficiency.</p>
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When you would take damage, you can <b>mark a Stress</b> to reduce the severity of the damage by one threshold.
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When 4 or more of the domain cards in your loadout are from the Valor domain, gain the following benefits:</p>
                     <ul class="list-disc list-inside ml-2">
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>Once per long rest, <b>mark 3 Stress</b> to push your body to its limits. Gain a <b>+2 bonus</b> to all of your character traits until your next rest.</p>`,
				character_modifiers: []
			}
		]
	},
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p><b>Spend 2 Hope</b> to strike the ground where you stand and make a <b>Strength Roll</b> against all targets within Very Close range.</p>
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>Describe the defensive stance you take and <b>spend a Hope</b>. If an adversary moves within Very Close range, they're pulled into Melee range and <em>Restrained</em>.</p>
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When you deal damage to an adversary, you can <b>mark a Stress</b> and describe how you encourage your allies.</p>
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When you <b>mark your last Hit Point</b>, instead of making a death move, you can roll a <b>d6</b> and <b>clear a number of Hit Points equal to the result</b>. Then place this card in your vault.</p>`,
				character_modifiers: []
			}
		]
	},
		...
		features: [
			{
				weapon_modifiers: [],
				title: '',
				description_html: `<p>When you would mark an Armor Slot, roll a number of <b>d6s</b> equal to your Proficiency. If any roll a 6, reduce the severity by one threshold without marking an Armor Slot.</p>`,
				character_modifiers: []
			}
		]
	}
