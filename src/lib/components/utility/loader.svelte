...
{#if isLoading && stillLoading}
	<div transition:fade class={cn('absolute inset-0 grid place-items-center', className)}>
		<!-- <LoaderCircle class={cn('h-8 w-8 animate-spin text-muted-foreground', spinnerClass)} /> -->
		<svg
			class="size-16"
			width="64"
			height="64"
		...
		>
			...
			<use
				...
				width="100%"
				height="100%"
				class="animate-pulse fill-muted-foreground"
				xlink:href="#p6"
			/>
			<use
				transform="matrix(.35278 0 0 .35278 -70.876 -44.38)"
				width="100%"
				height="100%"
				class="animate-pulse fill-muted-foreground [animation-delay:300ms]"
				xlink:href="#p16"
			/>
			<use
				transform="matrix(.35278 0 0 .35278 -70.876 -44.38)"
				width="100%"
				height="100%"
				class="animate-pulse fill-muted-foreground [animation-delay:600ms]"
				xlink:href="#p21"
			/>
		</svg>
	</div>
