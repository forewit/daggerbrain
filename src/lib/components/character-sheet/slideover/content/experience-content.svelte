<script lang="ts">
	...
	import ExperienceRules from '$lib/components/rule-snippets/experience-rules.svelte';
...
<div class="flex flex-col gap-6 overflow-y-auto px-4 pb-6">
	<Button variant="outline" href={`/characters/${character_id}/experiences/`} class="w-min">
		Edit Your Experiences <Pencil />
	</Button>
				...
				{#each character.experiences as experience, i}
					<tr class="border-b">
						<td class="px-4 py-2 text-left">
							{#if derived_character_data.experience_modifiers[i] > 0}+{/if}
