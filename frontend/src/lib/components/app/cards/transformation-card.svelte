  ...
  <div class="flex flex-col h-full bg-white rounded-[24px] border-[4px] border-accent overflow-hidden" style="zoom: {clientWidth / 360}">
    <!-- image and divider -->
      ...
      >
        ...
        />
        <p
          class="absolute uppercase leading-none bottom-[27px] left-[24px] text-[9px] text-black tracking-[2px] font-medium"
        >
          Transformation
        </p>
      </div>
      ...
      <!-- content -->
      <div class="flex flex-col shrink-0 gap-[6px] px-[12px] pb-[6px] pt-[8px]">
