    ...
    {#if expanded}
      ...
      >
        ...
        >
          ...
          {/if}
          <svg
            class="size-7 absolute left-1 top-1.5 text-background"
            width="64"
            height="64"
            version="1.1"
            viewBox="0 0 16.933 16.933"
          ...
          <svg
            class="size-7 absolute right-1 bottom-2 text-background"
            width="64"
            height="64"
            version="1.1"
            viewBox="0 0 16.933 16.933"
      ...
      {#if expanded}
        {#if counts.d4 > 0 || counts.d6 > 0 || counts.d8 > 0 || counts.d10 > 0 || counts.d12 > 0 || counts.d20 > 0 || counts.duality > 0}
          ...
          <button
            ...
            class="h-12 text-sm w-16 pl-1 rounded-r-full border border-l-0 border-accent/10 text-accent bg-accent/10 hover:bg-accent/20"
          >
            Roll
          </button>
        {:else}
