...
forced_in_vault: false,
    ...
    midnight_spirit: {
        ...
        image_url: "/images/card/art/domains/midnight/midnight-spirit.webp",
        type: "spell",
...
forced_in_vault: false,
    ...
    shadowbind: {
        ...
        image_url: "/images/card/art/domains/midnight/shadowbind.webp",
        type: "spell",
        title: "Shadowbind",
        description_html: "",
        level_requirement: 2,
...
forced_in_vault: false,
        ...
        features: [
            {
                attack_modifiers: [],
                title: "",
                description_html: "<p>Make a <b>Spellcast Roll</b> against all adversaries within Very Close range. Targets you succeed against are temporarily <em>Restrained</em> as their shadow binds them in place.</p>",
                character_modifiers: []
            }
        ],
    },
    chokehold: {
        ...
        image_url: "/images/card/art/domains/midnight/chokehold.webp",
        type: "ability",
        title: "Chokehold",
        description_html: "",
        level_requirement: 3,
...
forced_in_vault: false,
        ...
        features: [
            {
                attack_modifiers: [],
                title: "",
                description_html: "<p>When you position yourself behind a creature who's about your size, you can <b>mark a Stress</b> to pull them into a chokehold, making them temporarily <em>Vulnerable</em>.</p><p>When a creature attacks a target who is <em>Vulnerable</em> in this way, they deal an extra <b>2d6</b> damage.</p>",
                character_modifiers: []
            }
        ],
    },
    veil_of_night: {
        ...
        image_url: "/images/card/art/domains/midnight/veil-of-night.webp",
        type: "spell",
        title: "Veil of Night",
        description_html: "",
        level_requirement: 3,
...
forced_in_vault: false,
    ...
    glyph_of_nightfall: {
        ...
        domain_id: "midnight",
        artist_name: "Anthony Jones",
        image_url: "/images/card/art/domains/midnight/glyph-of-nightfall.webp",
        type: "spell",
...
forced_in_vault: false,
        ...
        features: [
            {
                attack_modifiers: [],
                title: "",
                description_html: "<p>Make a <b>Spellcast Roll</b> against a target within Very Close range. On a success, <b>spend a Hope</b> to conjure a dark glyph upon their body that exposes their weak points, temporarily reducing the target's Difficulty by a value equal to your Knowledge (minimum 1).</p>",
                character_modifiers: []
            }
        ],
    },
    stealth_expertise: {
        ...
        image_url: "/images/card/art/domains/midnight/stealth-expertise.webp",
        type: "ability",
...
forced_in_vault: false,
        ...
        features: [
            {
                attack_modifiers: [],
                title: "",
                description_html: "<p>When you roll with Fear while attempting to move unnoticed through a dangerous area, you can <b>mark a Stress</b> to roll with Hope instead.</p><p>If an ally within Close range is also attempting to move unnoticed and rolls with Fear, you can <b>mark a Stress</b> to change their result to a roll with Hope.</p>",
                character_modifiers: []
            }
        ],
    },
    hush: {
        ...
        image_url: "/images/card/art/domains/midnight/hush.webp",
        type: "spell",
        title: "Hush",
        description_html: "",
        level_requirement: 5,
...
forced_in_vault: false,
    ...
    phantom_retreat: {
        ...
        image_url: "/images/card/art/domains/midnight/phantom-retreat.webp",
        type: "spell",
...
forced_in_vault: false,
        ...
        features: [
            {
                attack_modifiers: [],
                title: "",
                description_html: "<p><b>Spend a Hope</b> to activate Phantom Retreat where you're currently standing. <b>Spend another Hope</b> at any time before your next rest to disappear from where you are and reappear where you were standing when you activated Phantom Retreat. This spell ends after you reappear.</p>",
                character_modifiers: []
            }
        ],
    },
    dark_whispers: {
        ...
        image_url: "/images/card/art/domains/midnight/dark-whispers.webp",
        type: "spell",
        title: "Dark Whispers",
        description_html: "",
        level_requirement: 6,
...
forced_in_vault: false,
    ...
    mass_disguise: {
        ...
        domain_id: "midnight",
        artist_name: "Anthony Jones",
        image_url: "/images/card/art/domains/midnight/mass-disguise.webp",
        type: "spell",
        title: "Mass Disguise",
        description_html: "",
        level_requirement: 6,
...
forced_in_vault: false,
    ...
    midnight_touched: {
        ...
        domain_id: "midnight",
        artist_name: "Joshua Rodriguez",
        image_url: "/images/card/art/domains/midnight/midnight-touched.webp",
        type: "ability",
...
forced_in_vault: false,
    ...
    vanishing_dodge: {
        ...
        image_url: "/images/card/art/domains/midnight/vanishing-dodge.webp",
        type: "spell",
...
forced_in_vault: false,
        ...
        features: [
            {
                attack_modifiers: [],
                title: "",
                description_html: "<p>When an attack made against you that would deal physical damage fails, you can <b>spend a Hope</b> to envelop yourself in shadow, becoming <em>Hidden</em> and teleporting to a point within Close range of the attacker. You remain <em>Hidden</em> until the next time you make an action roll.</p>",
                character_modifiers: []
            }
        ],
    },
    shadowhunter: {
        ...
        image_url: "/images/card/art/domains/midnight/shadowhunter.webp",
        type: "ability",
        title: "Shadowhunter",
        description_html: "",
        level_requirement: 8,
...
forced_in_vault: false,
        ...
        features: [
            {
                attack_modifiers: [],
                title: "",
                description_html: "<p>Your prowess is enhanced under the cover of shadow. While you're shrouded in low light or darkness, you gain a <b>+1</b> bonus to your Evasion and make attack rolls with advantage.</p>",
                character_modifiers: []
            }
        ],
    },
    spellcharge: {
        ...
        image_url: "/images/card/art/domains/midnight/spellcharge.webp",
        type: "spell",
        title: "Spellcharge",
        description_html: "",
        level_requirement: 8,
...
forced_in_vault: false,
    ...
    night_terror: {
        ...
        domain_id: "midnight",
        artist_name: "Anthony Jones",
        image_url: "/images/card/art/domains/midnight/night-terror.webp",
        type: "spell",
        title: "Night Terror",
        description_html: "",
        level_requirement: 9,
...
forced_in_vault: false,
    ...
    twilight_toll: {
        ...
        domain_id: "midnight",
        artist_name: "Rafater",
        image_url: "/images/card/art/domains/midnight/twilight-toll.webp",
        type: "ability",
        title: "Twilight Toll",
        description_html: "",
        level_requirement: 9,
...
forced_in_vault: false,
    ...
    eclipse: {
        ...
        domain_id: "midnight",
        artist_name: "Arturo G. González",
        image_url: "/images/card/art/domains/midnight/eclipse.webp",
        type: "spell",
        title: "Eclipse",
        description_html: "",
...
forced_in_vault: false,
    ...
    specter_of_the_dark: {
        ...
        image_url: "/images/card/art/domains/midnight/specter-of-the-dark.webp",
        type: "spell",
        ...
        features: [
            {
                attack_modifiers: [],
                title: "",
                description_html: "<p><b>Mark a Stress</b> to become <em>Spectral</em> until you make an action roll targeting another creature. While <em>Spectral</em>, you're immune to physical damage and can float and pass through solid objects. Other creatures can still see you while you're in this form.</p>",
                character_modifiers: []
            }
        ],
    }
