...
CREATE TABLE `__new_characters_table` (
	`id` text PRIMARY KEY DEFAULT 'c0a7af92-4dbb-49f3-a060-0aab9bda5c4c' NOT NULL,
	...
	`additional_character_modifier_ids` text DEFAULT '[]' NOT NULL,
	`additional_weapon_modifier_ids` text DEFAULT '[]' NOT NULL,
