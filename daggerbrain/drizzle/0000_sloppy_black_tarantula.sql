...
--> statement-breakpoint
CREATE INDEX `campaigns_table_gm_user_id_idx` ON `campaigns_table` (`gm_user_id`);--> statement-breakpoint
PRAGMA foreign_keys=OFF;--> statement-breakpoint
CREATE TABLE `__new_characters_table` (
	`id` text PRIMARY KEY DEFAULT 'c0dd934e-5dd7-4bde-9673-3c03a7707280' NOT NULL,
