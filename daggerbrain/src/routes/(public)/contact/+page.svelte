		...
		<div class="w-full max-w-lg space-y-6">
			...
			<div class="space-y-4">
				...
				<div class="flex gap-2">
					<Button  class="bg-accent hover:bg-accent/80 text-background" target="_blank" href="https://buymeacoffee.com/marcanderson">☕ Buy me a coffee</Button>

					<Button class="bg-[#5865F2] hover:bg-[#5865F2]/80" target="_blank" href="https://discord.gg/nTATkV7d9S">
