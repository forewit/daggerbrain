/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: f4d5b9555531aec01542992010fbb9b2)
...
declare namespace Cloudflare {
	interface Env {
		...
		CAMPAIGN_LIVE: DurableObjectNamespace /* CampaignLiveDO from campaigns-do */;
		R2_IMAGES: R2Bucket;
