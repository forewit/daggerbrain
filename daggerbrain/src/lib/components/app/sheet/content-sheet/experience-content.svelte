		...
		<Collapsible.Content>
			<div class="space-y-3 pt-2 pl-5 text-xs text-muted-foreground italic">
				...
				<ul class="list-disc space-y-3 pl-4">
					...
					<li>
						There's no set list of Experiences to choose from, but an Experience can't be too
						broadly applicable and it can't grant your character specific mechanical benefits, such
						as magic spells or special abilities. For example, "Lucky" and "Highly Skilled" are too
						broad, because they could be applied to virtually any roll. Likewise, "Supersonic
						Flight" and "Invulnerable" imply game-breaking special abilities.
					</li>
				</ul>
			</div>
		</Collapsible.Content>
