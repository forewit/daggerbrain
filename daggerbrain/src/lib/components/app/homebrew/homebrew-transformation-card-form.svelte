<script lang="ts">
	import type { Feature, TransformationCard } from '$lib/types/compendium-types';
	...
	// Check if form has changes compared to the transformationCard prop
	let hasChanges = $derived.by(() => {
		if (!transformationCard) return false;
