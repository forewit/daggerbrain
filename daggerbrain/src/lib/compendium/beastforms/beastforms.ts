		...
		features: [
			{
				title: "Companion",
				description_html:
					"When you Help an Ally, you can roll a <b>d8</b> as your advantage die.",
				character_modifiers: [],
				weapon_modifiers: []
			},
			{
	...
	features: [
		{
			title: "Fleet",
				description_html:
					"<b>Spend a Hope</b> to move up to Far range without rolling.",
				character_modifiers: [],
				weapon_modifiers: []
			},
			{
	...
	winged_beast: {
		...
		features: [
			...
			},
			{
				title: "Hollow Bones",
				description_html:
					"You gain a <b>−2</b> penalty to your damage thresholds.",
				character_modifiers: [
					{
						behaviour: "bonus",
						target: "major_damage_threshold",
